...
Local, private PNG/JPEG → WebP converter with **Cloudinary-style smart encoding**: smallest file at visually-lossless quality. No server, no upload — everything runs in your browser.

## Features

- 🖼️ Multiple PNG/JPEG upload (click or drag & drop)
...
- ✏️ Auto-rename: `My Photo-1.png` → `My_Photo_1.webp` (same for `.jpg`; spaces & dashes → underscores, unsafe chars sanitized)
...
Each PNG/JPEG is drawn to canvas and encoded at ascending WebP qualities. Every
